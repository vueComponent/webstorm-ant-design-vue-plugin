...
public class AntAnyXmlElementDescriptor extends AnyXmlElementDescriptor implements XmlElementDescriptor {

    private final String name;

    public AntAnyXmlElementDescriptor(XmlElementDescriptor parentDescriptor, XmlNSDescriptor xmlNSDescriptor, String name) {
